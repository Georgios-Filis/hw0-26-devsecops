...
def run_mtg_suite(input_folder=None, sra_code=False, contigs=False, protein_input=False, adapters_path="adapters.fa", protein_db_path="", kraken_db_path="", profiles_path="", profiles_taxonomy_path="", profiles_broad_path="", swissprot_path="", motifs_path="motifs.txt", options_file_path="", output_path="", seek_mode=True, taxonomy_mode=False, seek_route=1, taxonomy_route=1, seek_family_code=None, taxonomy_family_code=None, seek_db_name="", taxonomy_db_name="", input_seek_protein_names_status=False, input_seek_protein_names=None, input_taxonomy_protein_names_status=False, input_taxonomy_protein_names=None, name_thr=0.5, paired_end=True, compressed=True, prefetch_size=20, adapters_status="pre", add_seek_info=True, add_taxonomy_info=True, skip_fastqc=False, bbduk_max_ram=4, clear_space=False, k_list=None, kraken_threshold="", kraken_memory_mapping=True, bracken_length=150, bracken_level="S", bracken_threshold=10, binning_tool=1, bin_ram_ammount=4, bin_num_contig_len=500, bin_num_kmer=4, comebin_batch_size=256, cd_hit_t=0.99, cd_hit_mem=4000, prs_source=1, genetic_code=11, val_type="--cut_ga ", second_dom_search=True, e_value_nodom_thr=1e-70, add_type="", add_info="", thread_num=4, pdf_threads=None, fastqc_par=None, bbduk_par=None, megahit_par=None, fraggenescanrs_par=None, cd_hit_par=None, hmmscan_par=None, diamond_blastp_par=None, kraken_par=None, bracken_par=None, metabinner_par=None, comebin_par=None, bowtie_par=None, after_preprocessing=False, after_assembly=False, after_gene_pred=False, after_binning=False, after_mapping=False, after_db=False, after_tm=False, after_ap=False, up_to_sra=False, up_to_databases=False, up_to_preprocessing_com=False, up_to_preprocessing_uncom=False, up_to_alignment=False, sra_env="mtg_suite_env", fastqc_env="mtg_suite_env", bbduk_env="mtg_suite_env", megahit_env="mtg_suite_env", kraken_env="mtg_suite_env", bracken_env="mtg_suite_env", metabinner_env="mtg_suite_env", comebin_env="mtg_suite_env", cdhit_env="mtg_suite_env", genepred_env="", hmmer_env="mtg_suite_env", diamond_env="mtg_suite_env", taxonkit_env="mtg_suite_env", phobius_env="mtg_suite_env", bowtie_env="ps_bowtie", conda_bin="", conda_sh="", prefetch_path="", vdb_validate_path="", fastq_dump_path="", fastqc_path="", gzip_path="", cat_path="", bbduk_path="", megahit_path="", kraken_path="", bracken_path="", alpha_diversity_path="", metabinner_bin_path="", comebin_bin_path="", fraggenescanrs_path="", hmmscan_path="", hmmpress_path="", hmmfetch_path="", diamond_path="", cd_hit_path="", taxonkit_path="", phobius_path="", bowtie_build_path="", bowtie_path="", input_command=None):
    # Start time
    ...
    if (not after_db) and (not protein_input) and (not after_binning) and (not after_mapping) and (not after_tm) and (not after_ap):
        if not after_gene_pred:
            if (not os.path.exists(fullpath_contigs_formated)) or (os.path.getsize(fullpath_contigs_formated) == 0):
                print("The file with the contigs is empty. Exiting.")
                exit()
            # Gene scanning.
...
if __name__ == "__main__":
    ...
    # Tool environments
    arg_sra_env = "mtg_suite_env"
    arg_fastqc_env = "mtg_suite_env"
    arg_bbduk_env = "mtg_suite_env"
    arg_megahit_env = "mtg_suite_env"
    arg_kraken_env = "mtg_suite_env"
    arg_bracken_env = "mtg_suite_env"
    arg_metabinner_env = "mtg_suite_env"
    arg_comebin_env = "mtg_suite_env"
    arg_cdhit_env = "mtg_suite_env"
    arg_genepred_env = "mtg_suite_env"
    arg_hmmer_env = "mtg_suite_env"
    arg_diamond_env = "mtg_suite_env"
    arg_taxonkit_env = "mtg_suite_env"
    arg_phobius_env = "mtg_suite_env"
    arg_bowtie_env = "mtg_suite_env"
    # Tool paths
    arg_conda_bin = ""
    arg_conda_sh = ""
    arg_prefetch_path = ""
